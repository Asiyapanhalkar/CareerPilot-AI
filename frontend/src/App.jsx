...
const getNextRecommendation = () => {
  ...
  <div className="recommendation-box">
    <h3>🤖 CareerPilot AI Recommendation</h3>

    <p>
      Based on your progress, your next recommended skill is:
      <strong> {getNextRecommendation().skill}</strong>
    </p>

    <p>
      Reason: This skill is part of your target role requirements
      and is the next available learning step in your roadmap.
    </p>
  </div>
)}
              </div>
